...
export const AI_MODELS = [
  ...
  },
  {
    ...
    name: "Abyntra Lite",
    provider: "Abyntra Visual Engine",
    category: "image",
    tag: "Lightning 8K Visual & Speed Engine",
    badgeColor: "cyan",
    description: "Ultra-fast generation engine. Specialized in instant 8K photorealistic visual synthesis, high-resolution renders, and rapid responses.",
    contextWindow: 64000,
    speed: "Realtime Fast",
    pricing: "Lite / High Speed",
    supportsReasoning: false,
    supportsVision: true,
    isLite: true,
    recommendedFor: ["8K Image Generation", "Art Renders", "High-Speed Inference"]
  },
  {
