        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-b from-cyan-950/30 to-black/60 border border-cyan-500/30 space-y-4 shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title="When enabled, Abyntra automatically switches to newer model generations as they release"
                >
            ...
            <p className="text-xs text-gray-300 font-sans leading-relaxed">
              When <strong>Auto-Upgrade</strong> is active, Abyntra AI autonomously routes requests to newly released frontier models (e.g. Claude 3.7/4.0, GPT-4.5/5, DeepSeek R1/R2, Gemini 2.5) without needing manual updates.
            </p>
