    ...
    try {
      ...
      await openrouter.streamChat({
        messages: [
          {
            role: 'system',
            content: `You are the Abyntra Master Prompt Architect specializing in ${domain}. Transform the user's prompt into an ultra-detailed, precise, production-grade master instruction with clear objectives, constraints, architectural guidelines, and edge cases. Output ONLY the optimized prompt.`
          },
