      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl bg-[#04060A] border border-emerald-500/40 p-6 sm:p-8 text-white space-y-6 shadow-2xl shadow-emerald-950/40">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-white/10">
          <div className="flex items-center gap-2 text-xs font-mono text-gray-400">
            ...
            <span>Local Vault: <code className="text-emerald-300">%LocalAppData%\Abyntra AI Titan\Data</code></span>
          </div>

          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button
              onClick={() => {
                const targetModel = selectedProfile === 'lite' ? 'abyntra-titan-lite' : 'abyntra-titan-70b';
